...
#import OSVOS.encoding as encoding

from OSVOS.base import BaseNet
#from OSVOS.syncbn import BatchNorm2d
...
class GloRe_Unit(nn.Module):
    def __init__(self, num_in, num_mid, stride=(1,1), kernel=1):
        ...
        self.num_s = int(2 * num_mid) #state
        self.num_n = int(1 * num_mid) #node
...
class GCNet(BaseNet):
    ...
    """
    def __init__(self, nclass = 5, backbone = 'resnet152', aux=False, se_loss=False, norm_layer=nn.BatchNorm2d, gcn_search=None, **kwargs):
