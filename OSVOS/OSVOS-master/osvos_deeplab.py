...
#from deeplab.deeplab_v3_plus import DeepLabv3_plus
...
class DavisParent:
    ...
    def __init__(self, model_name):
        ...
        self.db_root_dir = 'OSVOS/'
        self.basepath = 'segmentation/'
    ...
    def main(self):
        ...
        self.opt = torch.optim.Adam([{'params': self.model.module.parameters(), 'lr': self.paras.lr*0.01}], lr=self.paras.lr,
...
if __name__ == '__main__':
    ...
    model = DavisParent(model_name='0723_deeplab_lr1e-4_Adam_decay10_12_weight')
    model.init_net()
    model.main()